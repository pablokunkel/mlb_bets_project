...
def rescore_row(row: pd.Series) -> dict:
    ...
    batter = {
        ...
        "recent_hr_14d": row.get("recent_hr_14d"),
        "recent_barrel_pct_14d": row.get("recent_barrel_pct_14d"),
        "ev_trend_14d": row.get("ev_trend_14d"),
    ...
    return {
        ...
        "weather": score_weather(weather, venue=venue, batter_hand="R"),
